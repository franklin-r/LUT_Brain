...
module DE10_Standard_QSYS_mm_interconnect_0 (
		...
		output wire [2:0]   timsestamp_timer_s1_address,                        //                          timsestamp_timer_s1.address
		output wire         timsestamp_timer_s1_write,                          //                                             .write
		input  wire [15:0]  timsestamp_timer_s1_readdata,                       //                                             .readdata
		output wire [15:0]  timsestamp_timer_s1_writedata,                      //                                             .writedata
		output wire         timsestamp_timer_s1_chipselect                      //                                             .chipselect
	);
	...
	wire   [31:0] timsestamp_timer_s1_agent_m0_readdata;                                              // timsestamp_timer_s1_translator:uav_readdata -> timsestamp_timer_s1_agent:m0_readdata
	wire          timsestamp_timer_s1_agent_m0_waitrequest;                                           // timsestamp_timer_s1_translator:uav_waitrequest -> timsestamp_timer_s1_agent:m0_waitrequest
	wire          timsestamp_timer_s1_agent_m0_debugaccess;                                           // timsestamp_timer_s1_agent:m0_debugaccess -> timsestamp_timer_s1_translator:uav_debugaccess
	wire   [31:0] timsestamp_timer_s1_agent_m0_address;                                               // timsestamp_timer_s1_agent:m0_address -> timsestamp_timer_s1_translator:uav_address
	wire    [3:0] timsestamp_timer_s1_agent_m0_byteenable;                                            // timsestamp_timer_s1_agent:m0_byteenable -> timsestamp_timer_s1_translator:uav_byteenable
	wire          timsestamp_timer_s1_agent_m0_read;                                                  // timsestamp_timer_s1_agent:m0_read -> timsestamp_timer_s1_translator:uav_read
	wire          timsestamp_timer_s1_agent_m0_readdatavalid;                                         // timsestamp_timer_s1_translator:uav_readdatavalid -> timsestamp_timer_s1_agent:m0_readdatavalid
	wire          timsestamp_timer_s1_agent_m0_lock;                                                  // timsestamp_timer_s1_agent:m0_lock -> timsestamp_timer_s1_translator:uav_lock
	wire   [31:0] timsestamp_timer_s1_agent_m0_writedata;                                             // timsestamp_timer_s1_agent:m0_writedata -> timsestamp_timer_s1_translator:uav_writedata
	wire          timsestamp_timer_s1_agent_m0_write;                                                 // timsestamp_timer_s1_agent:m0_write -> timsestamp_timer_s1_translator:uav_write
	wire    [2:0] timsestamp_timer_s1_agent_m0_burstcount;                                            // timsestamp_timer_s1_agent:m0_burstcount -> timsestamp_timer_s1_translator:uav_burstcount
	wire          timsestamp_timer_s1_agent_rf_source_valid;                                          // timsestamp_timer_s1_agent:rf_source_valid -> timsestamp_timer_s1_agent_rsp_fifo:in_valid
	wire  [112:0] timsestamp_timer_s1_agent_rf_source_data;                                           // timsestamp_timer_s1_agent:rf_source_data -> timsestamp_timer_s1_agent_rsp_fifo:in_data
	wire          timsestamp_timer_s1_agent_rf_source_ready;                                          // timsestamp_timer_s1_agent_rsp_fifo:in_ready -> timsestamp_timer_s1_agent:rf_source_ready
	wire          timsestamp_timer_s1_agent_rf_source_startofpacket;                                  // timsestamp_timer_s1_agent:rf_source_startofpacket -> timsestamp_timer_s1_agent_rsp_fifo:in_startofpacket
	wire          timsestamp_timer_s1_agent_rf_source_endofpacket;                                    // timsestamp_timer_s1_agent:rf_source_endofpacket -> timsestamp_timer_s1_agent_rsp_fifo:in_endofpacket
	wire          timsestamp_timer_s1_agent_rsp_fifo_out_valid;                                       // timsestamp_timer_s1_agent_rsp_fifo:out_valid -> timsestamp_timer_s1_agent:rf_sink_valid
	wire  [112:0] timsestamp_timer_s1_agent_rsp_fifo_out_data;                                        // timsestamp_timer_s1_agent_rsp_fifo:out_data -> timsestamp_timer_s1_agent:rf_sink_data
	wire          timsestamp_timer_s1_agent_rsp_fifo_out_ready;                                       // timsestamp_timer_s1_agent:rf_sink_ready -> timsestamp_timer_s1_agent_rsp_fifo:out_ready
	wire          timsestamp_timer_s1_agent_rsp_fifo_out_startofpacket;                               // timsestamp_timer_s1_agent_rsp_fifo:out_startofpacket -> timsestamp_timer_s1_agent:rf_sink_startofpacket
	wire          timsestamp_timer_s1_agent_rsp_fifo_out_endofpacket;                                 // timsestamp_timer_s1_agent_rsp_fifo:out_endofpacket -> timsestamp_timer_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_008_src_valid;                                                              // cmd_mux_008:src_valid -> timsestamp_timer_s1_agent:cp_valid
	wire  [111:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> timsestamp_timer_s1_agent:cp_data
	wire          cmd_mux_008_src_ready;                                                              // timsestamp_timer_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire    [8:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> timsestamp_timer_s1_agent:cp_channel
	wire          cmd_mux_008_src_startofpacket;                                                      // cmd_mux_008:src_startofpacket -> timsestamp_timer_s1_agent:cp_startofpacket
	wire          cmd_mux_008_src_endofpacket;                                                        // cmd_mux_008:src_endofpacket -> timsestamp_timer_s1_agent:cp_endofpacket
	...
	wire          timsestamp_timer_s1_agent_rp_valid;                                                 // timsestamp_timer_s1_agent:rp_valid -> router_011:sink_valid
	wire  [111:0] timsestamp_timer_s1_agent_rp_data;                                                  // timsestamp_timer_s1_agent:rp_data -> router_011:sink_data
	wire          timsestamp_timer_s1_agent_rp_ready;                                                 // router_011:sink_ready -> timsestamp_timer_s1_agent:rp_ready
	wire          timsestamp_timer_s1_agent_rp_startofpacket;                                         // timsestamp_timer_s1_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire          timsestamp_timer_s1_agent_rp_endofpacket;                                           // timsestamp_timer_s1_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire          timsestamp_timer_s1_agent_rdata_fifo_src_valid;                                     // timsestamp_timer_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire   [33:0] timsestamp_timer_s1_agent_rdata_fifo_src_data;                                      // timsestamp_timer_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire          timsestamp_timer_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_008:in_0_ready -> timsestamp_timer_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_008_out_0_valid;                                                  // avalon_st_adapter_008:out_0_valid -> timsestamp_timer_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_008_out_0_data;                                                   // avalon_st_adapter_008:out_0_data -> timsestamp_timer_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_008_out_0_ready;                                                  // timsestamp_timer_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire    [0:0] avalon_st_adapter_008_out_0_error;                                                  // avalon_st_adapter_008:out_0_error -> timsestamp_timer_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) timsestamp_timer_s1_translator (
		.clk                    (pll_outclk0_clk),                                    //                      clk.clk
		.reset                  (ELE8307_VGA_0_av_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (timsestamp_timer_s1_agent_m0_address),               // avalon_universal_slave_0.address
		.uav_burstcount         (timsestamp_timer_s1_agent_m0_burstcount),            //                         .burstcount
		.uav_read               (timsestamp_timer_s1_agent_m0_read),                  //                         .read
		.uav_write              (timsestamp_timer_s1_agent_m0_write),                 //                         .write
		.uav_waitrequest        (timsestamp_timer_s1_agent_m0_waitrequest),           //                         .waitrequest
		.uav_readdatavalid      (timsestamp_timer_s1_agent_m0_readdatavalid),         //                         .readdatavalid
		.uav_byteenable         (timsestamp_timer_s1_agent_m0_byteenable),            //                         .byteenable
		.uav_readdata           (timsestamp_timer_s1_agent_m0_readdata),              //                         .readdata
		.uav_writedata          (timsestamp_timer_s1_agent_m0_writedata),             //                         .writedata
		.uav_lock               (timsestamp_timer_s1_agent_m0_lock),                  //                         .lock
		.uav_debugaccess        (timsestamp_timer_s1_agent_m0_debugaccess),           //                         .debugaccess
		.av_address             (timsestamp_timer_s1_address),                        //      avalon_anti_slave_0.address
		.av_write               (timsestamp_timer_s1_write),                          //                         .write
		.av_readdata            (timsestamp_timer_s1_readdata),                       //                         .readdata
		.av_writedata           (timsestamp_timer_s1_writedata),                      //                         .writedata
		.av_chipselect          (timsestamp_timer_s1_chipselect),                     //                         .chipselect
		.av_read                (),                                                   //              (terminated)
		.av_begintransfer       (),                                                   //              (terminated)
		.av_beginbursttransfer  (),                                                   //              (terminated)
		.av_burstcount          (),                                                   //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) timsestamp_timer_s1_agent (
		.clk                     (pll_outclk0_clk),                                      //             clk.clk
		.reset                   (ELE8307_VGA_0_av_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
		.m0_address              (timsestamp_timer_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (timsestamp_timer_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (timsestamp_timer_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (timsestamp_timer_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (timsestamp_timer_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (timsestamp_timer_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (timsestamp_timer_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (timsestamp_timer_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (timsestamp_timer_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (timsestamp_timer_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (timsestamp_timer_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (timsestamp_timer_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (timsestamp_timer_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (timsestamp_timer_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (timsestamp_timer_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (timsestamp_timer_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (timsestamp_timer_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (timsestamp_timer_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (timsestamp_timer_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (timsestamp_timer_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (timsestamp_timer_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (timsestamp_timer_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (timsestamp_timer_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (timsestamp_timer_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (timsestamp_timer_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (timsestamp_timer_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_008_out_0_ready),                    // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_008_out_0_valid),                    //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_008_out_0_data),                     //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_008_out_0_error),                    //                .error
		.rdata_fifo_src_ready    (timsestamp_timer_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (timsestamp_timer_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (timsestamp_timer_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                                //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                  //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) timsestamp_timer_s1_agent_rsp_fifo (
		.clk               (pll_outclk0_clk),                                      //       clk.clk
		.reset             (ELE8307_VGA_0_av_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
		.in_data           (timsestamp_timer_s1_agent_rf_source_data),             //        in.data
		.in_valid          (timsestamp_timer_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (timsestamp_timer_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (timsestamp_timer_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (timsestamp_timer_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (timsestamp_timer_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (timsestamp_timer_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (timsestamp_timer_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (timsestamp_timer_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (timsestamp_timer_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                // (terminated)
		.csr_read          (1'b0),                                                 // (terminated)
		.csr_write         (1'b0),                                                 // (terminated)
		.csr_readdata      (),                                                     // (terminated)
	...
	DE10_Standard_QSYS_mm_interconnect_0_router_004 router_011 (
		.sink_ready         (timsestamp_timer_s1_agent_rp_ready),                 //      sink.ready
		.sink_valid         (timsestamp_timer_s1_agent_rp_valid),                 //          .valid
		.sink_data          (timsestamp_timer_s1_agent_rp_data),                  //          .data
		.sink_startofpacket (timsestamp_timer_s1_agent_rp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (timsestamp_timer_s1_agent_rp_endofpacket),           //          .endofpacket
		.clk                (pll_outclk0_clk),                                    //       clk.clk
		.reset              (ELE8307_VGA_0_av_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE10_Standard_QSYS_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_clk_0_clk   (pll_outclk0_clk),                                    // in_clk_0.clk
		.in_rst_0_reset (ELE8307_VGA_0_av_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (timsestamp_timer_s1_agent_rdata_fifo_src_data),      //     in_0.data
		.in_0_valid     (timsestamp_timer_s1_agent_rdata_fifo_src_valid),     //         .valid
		.in_0_ready     (timsestamp_timer_s1_agent_rdata_fifo_src_ready),     //         .ready
